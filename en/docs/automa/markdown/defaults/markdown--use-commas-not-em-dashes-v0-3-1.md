...
sat:changelog:
  ...
  - version: "0.1.0"
    date: "2026-07-23"
    author: "Christopher Steel"
    notes: "First versioned form. Migrated from an unversioned project-knowledge snippet into the sat-doc-automa repository."
---

# Markdown: Use Commas, Not Em Dashes
...
Use commas, not em dashes, in all markdown documents. Where an em dash would set off a parenthetical aside, use paired commas instead. Where an em dash would introduce an amplification or a list, use a comma or a colon.

## License

This document, *Markdown: Use Commas, Not Em Dashes*, by **Christopher Steel**, with AI assistance from **Claude Sonnet 4.6 (Anthropic)**, is licensed under the [GNU Affero General Public License v3.0 or later](https://www.gnu.org/licenses/agpl-3.0.html).
...
| 0.1.0 | Draft | First versioned form, migrated from an unversioned project-knowledge snippet |
