...
## 1. UUID registry — completed and wired up
...
## 2. Symmetric `relation` field (N-locale readiness)
...
## 3. `modality` field — accessibility Expressions
...
## 6. CMS structural fix — File Collections migration
